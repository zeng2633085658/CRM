...
public class OrdersCountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action.equals("list")) {
            ...
            request.getRequestDispatcher("/orderListCount.jsp").forward(request,response);
    ...
    private void list(HttpServletRequest request, HttpServletResponse response,String customerInfoVos,String usersVos,String stime,String etime)
        ...
        int cnt = base.findCountOrders1("销售出库");
        //自动生成总页数
        ...
        //设置操作符
        List<OrdersVo> list = base.findPageOrdersCount(pager.getStartRow(), pager.getPageRow(),customerInfoVos,usersVos,stime,etime);
        //查找部门
