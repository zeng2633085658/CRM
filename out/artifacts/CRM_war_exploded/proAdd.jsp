...
<blockquote class="layui-elem-quote"><h2>新增商品资料</h2></blockquote>

<form class="layui-form" action="<%=basePath%>productServlet?action=add" method="post" name="form1">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="prodstyle" lay-verify="required" autocomplete="off"
                       placeholder="请输入产品规格" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label"><span style="color: red;">*</span>库存数量</label>
            <div class="layui-input-inline">
                <input type="text" name="prodcounts" lay-verify="required" autocomplete="off"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="inprice" lay-verify="required" autocomplete="off"
                       placeholder="请输入进货价格" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="lowsaleprice" lay-verify="required" autocomplete="off"
                       placeholder="请输入最低价格" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="prodserial" placeholder="请输入商品序列号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">商品CDKEY</label>
            <div class="layui-input-inline">
                <input type="text" name="cdkey" placeholder="请输入商品CDKEY" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
