...
<blockquote class="layui-elem-quote"><h2>新增供应商资料</h2></blockquote>

<form class="layui-form" action="<%=basePath%>supplierServlet?action=add" method="post" name="form1">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <input type="text" name="contact" lay-verify="title" autocomplete="off"
                   placeholder="请输入联系人名称" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
