...
<head>
    ...
    $(function () {
        $("#btn1").click(function () {
            x_admin_upload('合同附件','<%=basePath%>uploadFile/'+$("#test").val());
        });
    });
...
<blockquote class="layui-elem-quote"><h2>修改合同扫描附件</h2></blockquote>

<form class="layui-form" action="<%=basePath%>contractAttachServlet?action=updateSave" method="post" name="form1">
    <input type="hidden" name="contractAttach_id" value="${cona.contractAttach_id}">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="seq" lay-verify="required" autocomplete="off"
                       placeholder="请输入排序号" class="layui-input" value="${cona.seq}">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="attachFile" lay-verify="required" autocomplete="off"
                       placeholder="请输入附件名称" class="layui-input" value="${cona.attachFile}">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    ...
                    <input type="hidden" id="test" name="attachURL" value="${cona.attachURL}">
                    <div class="layer-photos-demo" >
                        <p id="img1"><img class="layui-upload-img" src="<%=basePath%>uploadFile/${cona.attachURL}" id="demo1"></p>
                        <p id="demoText"></p>
                    </div>
                </div>
            </div>
