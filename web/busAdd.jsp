...
<blockquote class="layui-elem-quote"><h2>新增商务洽谈</h2></blockquote>

<form class="layui-form" action="<%=basePath%>businessServlet?action=add" method="post" name="form1">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="chatContent"  autocomplete="off" lay-verify="required"
                       placeholder="请输入洽谈内容" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="chatResult" autocomplete="off" lay-verify="required"
                       placeholder="请输入洽谈情况" class="layui-input">
            </div>
        </div>
    </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="custContact" autocomplete="off" lay-verify="required"
                       placeholder="请输入客户联系人" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="module" lay-verify="required" autocomplete="off"
                       placeholder="请输入报价模块" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="moduleState" lay-verify="required" autocomplete="off"
                       placeholder="请输入报价情况" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="moduleMoney" lay-verify="required" autocomplete="off"
                       placeholder="请输入报价金额" class="layui-input">
            </div>
        </div>
    </div>
