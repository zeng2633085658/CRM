...
<form class="layui-form" action="<%=basePath%>contactServlet?action=add" method="post" name="form1">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="qqCode" placeholder="请输入QQ号码" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="birthday" lay-verify="required" autocomplete="off"
                       placeholder="请输入客户生日" class="layui-input" id="birthday">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="hobbit" autocomplete="off"
                       placeholder="请输入喜爱" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
